...
const socialLinks = [
  { icon: <GitHubIcon />, label: 'GitHub', href: 'https://github.com/Farasat123' },
  { icon: <LinkedInIcon />, label: 'LinkedIn', href: 'https://linkedin.com/in/farasat-abbas-profile' },
  { icon: <LanguageIcon />, label: 'Portfolio', href: 'https://farasat-portfolio.vercel.app/' },
  { icon: <EmailIcon />, label: 'Email', href: 'mailto:abbasfarasat0786@gmail.com' },
];
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 6, md: 8 } }}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} justifyContent="space-between" alignItems={{ xs: 'flex-start', md: 'center' }}>
          <Typography variant="body2" sx={{ color: 'rgba(226,232,240,0.7)' }}>
            © {new Date().getFullYear()} Fusion Electronics.
          </Typography>
